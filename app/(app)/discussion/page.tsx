    ...
    <div className="mx-auto flex h-full max-w-3xl flex-col space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Company-wide chat — live for everyone across IND, UAE and KSA. Share files and photos too.
        </p>
      </div>

      <DiscussionThread meId={user.id} isAdmin={user.role === "ADMIN"} initialMessages={initialMessages} />
    </div>
  );
}
